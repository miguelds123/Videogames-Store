...
Insert into CANTON values (8, 1, 'Goicochea')
Insert into CANTON values (9, 1, 'Santa Ana')
Insert into CANTON values (10, 1, 'Alajuelita')
Insert into CANTON values (11, 1, 'Vázquez de Coronado')
...
Insert into CANTON values (20, 1, 'León Cortés Castro')


-- Inserts Cantones Alajuela
...
Insert into CANTON values (11, 2, 'Alfaro Ruiz')
...
Insert into CANTON values (15, 2, 'Guatusa')


-- Inserts Cantones Cartago
...
Insert into CANTON values (5, 4, 'San Rafael')
...
Insert into CANTON values (10, 4, 'Sarapaquí')


-- Inserts Cantones Guanacaste
...
Insert into CANTON values (5, 5, 'Carillo')
Insert into CANTON values (6, 5, 'Cañas')
Insert into CANTON values (7, 5, 'Abangares')
